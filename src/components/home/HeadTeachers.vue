<template>
  <div>
    <div class="cofe-white cofe-margin">
      <img
        src="/Lumii_20210523_095246763.jpg"
        alt="mr harrison"
      ...
      <div class="cofe-container cofe-black">
        ...
        <p class="paragraphText">
          ...
          Taking the school from the trinity status into the amaglation phase
          into as we know now Christ The King. A series of dedicated teachers
          who excelled at being the very best for the staff and students.
        </p>
      </div>
    </div>
    <hr />
