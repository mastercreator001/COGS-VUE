    ...
    return {
      gallery: [
        ...
        },
        {
          id: 2,
          title: "Nearly Done",
          text: "The planning and ultimate desrtuction of the school was unique as the school was dug into the hills natural incline. As to it's end and as per building regualtions the school and the foundation footings were entirely removed so as the new additon to the land was afforded the suitable foundations.",
...
<style scoped>
.demolitionContainer {background-color: rgb(251, 246, 246); display: inline-block; padding-top: 50px; padding-bottom: 50px;  font-weight: normal; margin: 9px 9px 9px 9px;}
.galleryContainer {display: inline-flex; flex-wrap: wrap; flex: 22%; padding: 50px 5px;  font-weight: bold; text-underline-offset: 10px; margin:25px;}
